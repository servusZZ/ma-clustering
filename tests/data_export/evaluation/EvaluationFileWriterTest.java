...
class EvaluationFileWriterTest {
	...
	void testWriteAndAppendToEvaluationFile() throws IOException {
		...
		ProjectEvaluationEntry projectMetrics = new ProjectEvaluationEntry(1, "biojavaTest", 5, 38, 120, 50);
	...
	void testWriteNewFileWithNullClusterMetrics() throws IOException {
		...
		ProjectEvaluationEntry projectMetrics = new ProjectEvaluationEntry(15, "biojavaTest", 10, 90, 20, 50);
